...
restore, single-click the program's icon in the tray. You can also minimize by
holding SHIFT and right-clicking the title bar of an app or pressing
WIN-ALT-DOWN ARROW on the keyboard to minimize the active window.
